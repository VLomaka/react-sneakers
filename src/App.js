...
function App() {
  ...
  React.useEffect(() => {
    async function fetchData() {
      ...
      const cartResponse = await axios.get('https://6323470d362b0d4e7de06fcd.mockapi.io/cart');
      const favoritesResponse = await axios.get('https://6323470d362b0d4e7de06fcd.mockapi.io/favorites');
      const itemsResponse = await axios.get('https://6323470d362b0d4e7de06fcd.mockapi.io/items');
  ...
  const onAddToFavorite = async (obj) => {
    try {
      if (favorites.find((favObj) => Number(favObj.id) === Number(obj.id))) {
        ...
        const { data } = await axios.post('https://6323470d362b0d4e7de06fcd.mockapi.io/favorites', obj);
